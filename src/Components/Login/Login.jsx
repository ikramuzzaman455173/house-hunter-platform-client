...
const Login = () => {
  ...
  return (
    <div className='flex justify-center items-center min-h-screen mt-5'>
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-white shadow-md border-rose-500 dark:border-info border-2 text-slate-600  dark:bg-gradient-to-r  dark:text-white dark:border-2'>
        ...
        >
          ...
          <div>
            <button
              type='submit'
              className='bg-info dark:bg-rose-500 w-full awesome-btn text-center rounded-md py-3 font-bold tracking-wider dark:font-Merienda font-Pt text-[18px] text-white'
            >
